...
ALTER TABLE ONLY "public"."Tutorial"
    ADD CONSTRAINT "Tutorial_youtube_id_key" UNIQUE ("youtube_id");

ALTER TABLE ONLY "public"."Tutorial"
    ADD CONSTRAINT "tutorial_pkey" PRIMARY KEY ("id");

CREATE POLICY "Enable read access to everyone" ON "public"."Tutorial" FOR SELECT USING (true);
...
GRANT ALL ON SEQUENCE "public"."Tutorial_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."Tutorial_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."Tutorial_id_seq" TO "service_role";
